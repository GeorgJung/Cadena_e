 ...
 * @generated
 */
public class GraphicalprocesseditormodelPackageImpl extends EPackageImpl implements GraphicalprocesseditormodelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see GraphicalProcessEditor.graphicalprocesseditormodel.GraphicalprocesseditormodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GraphicalprocesseditormodelPackageImpl() {
		super(eNS_URI, GraphicalprocesseditormodelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GraphicalprocesseditormodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GraphicalprocesseditormodelPackage init() {
		if (isInited) return (GraphicalprocesseditormodelPackage)EPackage.Registry.INSTANCE.getEPackage(GraphicalprocesseditormodelPackage.eNS_URI);

		// Obtain or create and register package
		GraphicalprocesseditormodelPackageImpl theGraphicalprocesseditormodelPackage = (GraphicalprocesseditormodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GraphicalprocesseditormodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GraphicalprocesseditormodelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theGraphicalprocesseditormodelPackage.createPackageContents();

		// Initialize created meta-data
		theGraphicalprocesseditormodelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theGraphicalprocesseditormodelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GraphicalprocesseditormodelPackage.eNS_URI, theGraphicalprocesseditormodelPackage);
		return theGraphicalprocesseditormodelPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOutputPort_Value() {
	...
	public void createPackageContents() {
		...
		createEAttribute(outputPortEClass, OUTPUT_PORT__VALUE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOutputPort_Value(), ecorePackage.getEString(), "Value", null, 0, 1, OutputPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //GraphicalprocesseditormodelPackageImpl
