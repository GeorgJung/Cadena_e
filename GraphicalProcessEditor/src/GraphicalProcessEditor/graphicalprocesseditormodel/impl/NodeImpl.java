 ...
 * <ul>
 *   <li>{@link GraphicalProcessEditor.graphicalprocesseditormodel.impl.NodeImpl#getTransactions <em>Transactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NodeImpl extends EObjectImpl implements Node {
	...
	public EList<Transaction> getTransactions() {
		if (transactions == null) {
			transactions = new EObjectContainmentEList<Transaction>(Transaction.class, this, GraphicalprocesseditormodelPackage.NODE__TRANSACTIONS);
		}
		return transactions;
	}
