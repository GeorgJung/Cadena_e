...
public class GraphEditorModelBaseItemSemanticEditPolicy extends
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = GraphEditor.grapheditormodel.diagram.providers.GraphEditorModelElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = GraphEditor.grapheditormodel.diagram.part.GraphEditorModelDiagramEditorPlugin
	...
	public static class LinkConstraints {
		...
		public boolean canExistEdge_4001(
				GraphEditor.grapheditormodel.Node container,
				GraphEditor.grapheditormodel.Edge linkInstance,
				GraphEditor.grapheditormodel.Node source,
				GraphEditor.grapheditormodel.Node target) {
			return true;
		}
