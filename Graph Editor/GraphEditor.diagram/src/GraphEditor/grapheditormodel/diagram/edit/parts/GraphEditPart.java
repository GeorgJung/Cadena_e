...
public class GraphEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new GraphEditor.grapheditormodel.diagram.edit.policies.GraphItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new GraphEditor.grapheditormodel.diagram.edit.policies.GraphCanonicalEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						GraphEditor.grapheditormodel.diagram.part.GraphEditorModelVisualIDRegistry.TYPED_INSTANCE));
