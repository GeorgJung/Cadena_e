...
public class EdgeValueEditPart extends LabelEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new GraphEditor.grapheditormodel.diagram.edit.policies.GraphEditorModelTextSelectionEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new GraphEditor.grapheditormodel.diagram.edit.parts.GraphEditPart.LinkLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return GraphEditor.grapheditormodel.diagram.providers.GraphEditorModelElementTypes
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GraphEditor.grapheditormodel.diagram.providers.GraphEditorModelParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					GraphEditor.grapheditormodel.diagram.edit.parts.GraphEditorModelEditPartFactory
