...
public class GraphEditorModelDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof GraphEditor.grapheditormodel.diagram.navigator.GraphEditorModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((GraphEditor.grapheditormodel.diagram.navigator.GraphEditorModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new GraphEditor.grapheditormodel.diagram.navigator.GraphEditorModelDomainNavigatorItem(
