...
public class GraphEditorModelParserProvider extends AbstractProvider implements
	...
	private IParser getNodeName_5001Parser() {
		if (nodeName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { GraphEditor.grapheditormodel.GrapheditormodelPackage.eINSTANCE
					.getNode_Name() };
			GraphEditor.grapheditormodel.diagram.parsers.MessageFormatParser parser = new GraphEditor.grapheditormodel.diagram.parsers.MessageFormatParser(
					features);
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(GraphEditor.grapheditormodel.diagram.part.GraphEditorModelVisualIDRegistry
					.getVisualID(vid));
		}
