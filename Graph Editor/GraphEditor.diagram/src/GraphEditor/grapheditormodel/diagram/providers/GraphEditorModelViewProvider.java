...
public class GraphEditorModelViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = GraphEditor.grapheditormodel.diagram.part.GraphEditorModelVisualIDRegistry
					.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = GraphEditor.grapheditormodel.diagram.part.GraphEditorModelVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!GraphEditor.grapheditormodel.diagram.providers.GraphEditorModelElementTypes
		...
		return GraphEditor.grapheditormodel.diagram.edit.parts.NodeEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(GraphEditor.grapheditormodel.diagram.edit.parts.GraphEditPart.MODEL_ID);
	...
	public Node createNode_2001(EObject domainElement, View containerView,
		...
		node.setType(GraphEditor.grapheditormodel.diagram.part.GraphEditorModelVisualIDRegistry
	...
	public Edge createEdge_4001(EObject domainElement, View containerView,
		...
		edge.setType(GraphEditor.grapheditormodel.diagram.part.GraphEditorModelVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!GraphEditor.grapheditormodel.diagram.edit.parts.GraphEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", GraphEditor.grapheditormodel.diagram.edit.parts.GraphEditPart.MODEL_ID); //$NON-NLS-1$
