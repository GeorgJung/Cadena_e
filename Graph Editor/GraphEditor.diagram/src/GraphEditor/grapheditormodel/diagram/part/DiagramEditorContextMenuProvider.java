...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private GraphEditor.grapheditormodel.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new GraphEditor.grapheditormodel.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
