...
public class NodeNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new GraphEditor.graphmodel.diagram.edit.policies.GraphModelTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new GraphEditor.graphmodel.diagram.edit.parts.GraphEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return GraphEditor.graphmodel.diagram.providers.GraphModelElementTypes
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GraphEditor.graphmodel.diagram.providers.GraphModelParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					GraphEditor.graphmodel.diagram.edit.parts.GraphModelEditPartFactory
