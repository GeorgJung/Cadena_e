 ...
 * @generated
 */
public class GraphModelViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = GraphEditor.graphmodel.diagram.part.GraphModelVisualIDRegistry
					.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = GraphEditor.graphmodel.diagram.part.GraphModelVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!GraphEditor.graphmodel.diagram.providers.GraphModelElementTypes
		...
		return GraphEditor.graphmodel.diagram.edit.parts.NodeEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(GraphEditor.graphmodel.diagram.edit.parts.GraphEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case GraphEditor.graphmodel.diagram.edit.parts.NodeEdgeEditPart.VISUAL_ID:
			return createNodeEdge_4001(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createNode_2001(EObject domainElement, View containerView,
		...
		node.setType(GraphEditor.graphmodel.diagram.part.GraphModelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createNodeEdge_4001(View containerView, int index,
		...
		edge.setType(GraphEditor.graphmodel.diagram.part.GraphModelVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!GraphEditor.graphmodel.diagram.edit.parts.GraphEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", GraphEditor.graphmodel.diagram.edit.parts.GraphEditPart.MODEL_ID); //$NON-NLS-1$
