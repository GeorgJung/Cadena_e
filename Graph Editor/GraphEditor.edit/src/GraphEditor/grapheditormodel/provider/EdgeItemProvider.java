...
/**
 * This is the item provider adapter for a {@link GraphEditor.grapheditormodel.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_Value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_Value_feature", "_UI_Edge_type"),
				 GrapheditormodelPackage.Literals.EDGE__VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrapheditormodelPackage.Literals.EDGE__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrapheditormodelPackage.Literals.EDGE__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Edge)object).getValue();
