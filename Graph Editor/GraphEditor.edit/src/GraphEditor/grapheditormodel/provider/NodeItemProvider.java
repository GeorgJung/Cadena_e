...
/**
 * This is the item provider adapter for a {@link GraphEditor.grapheditormodel.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrapheditormodelPackage.Literals.NODE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GrapheditormodelPackage.Literals.NODE__INCOMING_EDGES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrapheditormodelPackage.Literals.NODE__OUT_GOING_EDGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrapheditormodelPackage.Literals.NODE__OUT_GOING_EDGES,
				 GrapheditormodelFactory.eINSTANCE.createEdge()));
	}
