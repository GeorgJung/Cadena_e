...
public class ProcessTest extends NodeTest {
	 ...
	 */
	@Override
	protected GraphicalProcessEditor.graphicalprocesseditormodel.Process getFixture() {
		return (GraphicalProcessEditor.graphicalprocesseditormodel.Process)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(GraphicalprocesseditormodelFactory.eINSTANCE.createProcess());
	}
