 ...
 * @generated
 */
public class GraphicalProcessEditorModelElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public GraphicalProcessEditorModelElementChooserDialog(Shell parentShell,
			View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						GraphicalProcessEditor.graphicalprocesseditormodel.diagram.part.Messages.GraphicalProcessEditorModelElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "graphicalprocesseditormodel".equals(fileExtension); //$NON-NLS-1$
	}
