...
public class GraphicalProcessEditorModelNavigatorLabelProvider extends
	...
	public Image getImage(View view) {
		...
		case GraphicalProcessEditor.graphicalprocesseditormodel.diagram.edit.parts.NodeEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://graphicalprocesseditormodel/1.0?Node", GraphicalProcessEditor.graphicalprocesseditormodel.diagram.providers.GraphicalProcessEditorModelElementTypes.Node_2001); //$NON-NLS-1$
		...
		case GraphicalProcessEditor.graphicalprocesseditormodel.diagram.edit.parts.EdgeEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://graphicalprocesseditormodel/1.0?Edge", GraphicalProcessEditor.graphicalprocesseditormodel.diagram.providers.GraphicalProcessEditorModelElementTypes.Edge_4001); //$NON-NLS-1$
		}
