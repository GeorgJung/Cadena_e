...
public class MessageFormatParser
		extends
		GraphicalProcessEditor.graphicalprocesseditormodel.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							GraphicalProcessEditor.graphicalprocesseditormodel.diagram.part.Messages.MessageFormatParser_InvalidInputError,
