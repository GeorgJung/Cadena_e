...
public class NodeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		GraphicalProcessEditor.graphicalprocesseditormodel.Node newElement = GraphicalProcessEditor.graphicalprocesseditormodel.GraphicalprocesseditormodelFactory.eINSTANCE
				.createNode();
	...
	protected void doConfigure(
			GraphicalProcessEditor.graphicalprocesseditormodel.Node newElement,
