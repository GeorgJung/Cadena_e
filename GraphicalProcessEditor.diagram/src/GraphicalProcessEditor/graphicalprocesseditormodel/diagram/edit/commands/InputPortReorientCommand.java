 ...
 * @generated
 */
public class InputPortReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InputPortReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GraphicalProcessEditor.graphicalprocesseditormodel.InputPort) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected GraphicalProcessEditor.graphicalprocesseditormodel.InputPort getLink() {
		return (GraphicalProcessEditor.graphicalprocesseditormodel.InputPort) getElementToEdit();
	}
