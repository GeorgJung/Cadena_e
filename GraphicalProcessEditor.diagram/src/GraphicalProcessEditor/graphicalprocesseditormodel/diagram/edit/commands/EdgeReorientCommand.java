...
public class EdgeReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GraphicalProcessEditor.graphicalprocesseditormodel.Edge) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected GraphicalProcessEditor.graphicalprocesseditormodel.Edge getLink() {
		return (GraphicalProcessEditor.graphicalprocesseditormodel.Edge) getElementToEdit();
	}
