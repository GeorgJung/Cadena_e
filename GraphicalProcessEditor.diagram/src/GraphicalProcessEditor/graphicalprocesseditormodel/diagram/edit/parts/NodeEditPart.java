...
public class NodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new GraphicalProcessEditor.graphicalprocesseditormodel.diagram.edit.policies.NodeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GraphicalProcessEditor.graphicalprocesseditormodel.diagram.edit.parts.NodeNameEditPart) {
			((GraphicalProcessEditor.graphicalprocesseditormodel.diagram.edit.parts.NodeNameEditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(GraphicalProcessEditor.graphicalprocesseditormodel.diagram.providers.GraphicalProcessEditorModelElementTypes.Edge_4001);
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == GraphicalProcessEditor.graphicalprocesseditormodel.diagram.providers.GraphicalProcessEditorModelElementTypes.Edge_4001) {
