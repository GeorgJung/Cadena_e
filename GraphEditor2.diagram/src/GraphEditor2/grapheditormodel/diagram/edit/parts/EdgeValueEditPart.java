 ...
 * @generated
 */
public class EdgeValueEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EdgeValueEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new GraphEditor2.grapheditormodel.diagram.edit.policies.GraphEditorModelTextSelectionEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new GraphEditor2.grapheditormodel.diagram.edit.parts.GraphEditPart.LinkLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return GraphEditor2.grapheditormodel.diagram.providers.GraphEditorModelElementTypes
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GraphEditor2.grapheditormodel.diagram.providers.GraphEditorModelParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					GraphEditor2.grapheditormodel.diagram.edit.parts.GraphEditorModelEditPartFactory
