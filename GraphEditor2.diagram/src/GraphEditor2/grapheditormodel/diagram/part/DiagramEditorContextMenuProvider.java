...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private GraphEditor2.grapheditormodel.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new GraphEditor2.grapheditormodel.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
