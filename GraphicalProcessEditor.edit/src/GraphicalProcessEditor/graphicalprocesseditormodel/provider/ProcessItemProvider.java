...
/**
 * This is the item provider adapter for a {@link GraphicalProcessEditor.graphicalprocesseditormodel.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider
	...
	protected void addImagePathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_ImagePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_ImagePath_feature", "_UI_Process_type"),
				 GraphicalprocesseditormodelPackage.Literals.PROCESS__IMAGE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphicalprocesseditormodelPackage.Literals.PROCESS__OUTPUT_PORTS);
			childrenFeatures.add(GraphicalprocesseditormodelPackage.Literals.PROCESS__INPUT_PORT);
		}
	...
	public String getText(Object object) {
		String label = ((GraphicalProcessEditor.graphicalprocesseditormodel.Process)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphicalprocesseditormodelPackage.Literals.PROCESS__OUTPUT_PORTS,
				 GraphicalprocesseditormodelFactory.eINSTANCE.createOutputPort()));

		newChildDescriptors.add
			(createChildParameter
				(GraphicalprocesseditormodelPackage.Literals.PROCESS__INPUT_PORT,
